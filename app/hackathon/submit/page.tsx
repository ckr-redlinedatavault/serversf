        ...
        <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-[#92E3A9] selection:text-black">
            ...
            <main className="max-w-2xl mx-auto px-6 py-16 md:py-24">
                <div className="mb-12">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold tracking-tighter leading-tight mt-6 mb-4">
                        Project Submission
                    </h1>
                    <p className="text-zinc-500 text-sm font-medium leading-relaxed max-w-md">
                        Deploy your project repository to the Forge Registry. Every submission is recorded instantly.
                    </p>
                </div>

                <div className="bg-zinc-950 border border-zinc-900 rounded-[2rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                        <div className="space-y-2">
                            <label className="text-[10px] font-semibold text-zinc-500 uppercase tracking-widest ml-1">Team Name</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-semibold text-zinc-500 uppercase tracking-widest ml-1">Team Leader</label>
                            <div className="relative">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between ml-1">
                                <label className="text-[10px] font-semibold text-zinc-500 uppercase tracking-widest">Team Members</label>
                                <button 
                                    type="button" 
                                    onClick={addMember}
                                    className="text-[10px] font-semibold text-[#92E3A9] hover:underline flex items-center gap-1"
                                >
                                    ...
                                    <div key={index} className="flex gap-2 animate-in slide-in-from-left-2 duration-300">
                                        ...
                                        {members.length > 1 && (
                                            <button 
                                                ...
                                                className="p-4 bg-zinc-900 border border-zinc-800 rounded-xl text-zinc-700 hover:text-red-500 transition-all"
                                            >
                        ...
                        <div className="space-y-2 pt-4 border-t border-zinc-900">
                            <label className="text-[10px] font-semibold text-zinc-500 uppercase tracking-widest ml-1">GitHub Repository</label>
                            <div className="relative">
                        ...
                        {error && <p className="text-red-500 text-[10px] font-semibold uppercase tracking-widest">{error}</p>}

                        <button 
                            disabled={submitting}
                            className="w-full bg-[#92E3A9] text-black py-4 rounded-xl font-bold text-xs hover:bg-white transition-all shadow-xl shadow-[#92E3A9]/10 flex items-center justify-center gap-3 mt-4"
                        >
                            {submitting ? <Loader2 className="w-4 h-4 animate-spin" /> : <>Submit Project</>}
                        </button>
                    </form>
                </div>
            </main>
