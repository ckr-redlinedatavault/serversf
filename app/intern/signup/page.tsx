...
import { Mail, Lock, User, ShieldAlert, ArrowRight, Loader2, Star, ArrowLeft } from "lucide-react";
            ...
            <nav className="sticky top-0 z-50 w-full border-b border-black/5 bg-[#92E3A9]">
                <div className="mx-auto flex h-14 w-full max-w-7xl items-center justify-between px-6 lg:px-10">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[11px] font-bold text-black uppercase tracking-widest">Intern Portal</span>
                    </div>
                </div>
            </nav>
                    ...
                    <div className="w-full max-w-[360px] space-y-8 relative z-10">
                        <div className="space-y-6">
                            <div className="space-y-1">
                                <h1 className="text-2xl font-bold tracking-tight">Create Intern ID</h1>
                                <p className="text-zinc-400 text-[13px]">Start your application process today.</p>
                            </div>
                        ...
                        <div className="mt-8 text-center pt-6 border-t border-zinc-100">
                            <p className="text-[13px] text-zinc-500 font-medium tracking-tight">
                                Already have an intern ID? <Link href="/intern/signin" className="text-black font-bold border-b border-black ml-1.5">Login</Link>
                            </p>
                        </div>
                    </div>
                </div>
